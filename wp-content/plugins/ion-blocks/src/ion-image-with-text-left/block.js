			...
			<div className="wp-block-columns ion-text-with-img-wrapper ion-pad-ver-med">
				<div className="wp-block-column">
					<div className="ion-twi-col-left">
						...
						<img src={ attributes.imageUrl3 } alt="" className="twi-image" />
					</div>
				</div>
				<div className="wp-block-column">
...
registerBlockType( 'cgb/ion-image-with-text-left', {
	title: __( 'Ion Image With Text Left' ),
	icon: 'shield',
	category: 'common',
	keywords: [
				...
				<div className="container">
					<div className="row">
						<div className="col-12 col-lg-6">
							<div className="ion-twi-col-left pb-5 pb-0">
								<img src={ props.attributes.imageUrl1 } alt="" className="twi-shape-bg" />
								<img src={ props.attributes.imageUrl2 } alt="" className="twi-shape-bg-2" />
